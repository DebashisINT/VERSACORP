package com.breezefieldsalesversacorp.features.logoutsync.presentation
...
import com.breezefieldsalesversacorp.app.AppDatabase
...
import com.breezefieldsalesversacorp.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldsalesversacorp.features.billing.api.AddBillingRepoProvider
import com.breezefieldsalesversacorp.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldsalesversacorp.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldsalesversacorp.features.document.model.AddEditDocumentInputParams
import com.breezefieldsalesversacorp.features.document.model.DocumentAttachmentModel
...
import com.breezefieldsalesversacorp.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefieldsalesversacorp.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldsalesversacorp.features.orderhistory.model.*
...
import com.breezefieldsalesversacorp.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldsalesversacorp.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldsalesversacorp.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldsalesversacorp.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldsalesversacorp.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldsalesversacorp.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldsalesversacorp.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldsalesversacorp.mappackage.SendBrod
import com.breezefieldsalesversacorp.widgets.AppCustomTextView
import com.breezefieldsalesversacorp.MonitorService
import com.breezefieldsalesversacorp.MySingleton
import com.breezefieldsalesversacorp.app.AlarmReceiver
...
import com.breezefieldsalesversacorp.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldsalesversacorp.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldsalesversacorp.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldsalesversacorp.features.orderITC.SyncDeleteOpptL
...
import com.breezefieldsalesversacorp.features.orderITC.SyncOpptProductL
import com.breezefieldsalesversacorp.features.orderITC.SyncOrd
import com.breezefieldsalesversacorp.features.orderITC.SyncOrdProductL
import com.breezefieldsalesversacorp.features.performance.model.Gps_status_list
import com.breezefieldsalesversacorp.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldsalesversacorp.features.returnsOrder.ReturnProductList
import com.breezefieldsalesversacorp.features.returnsOrder.ReturnRequest
import com.breezefieldsalesversacorp.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesversacorplogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesversacorplogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesversacorplogsample/log.zip").path);
