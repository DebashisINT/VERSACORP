package com.breezefieldsalesversacorp.features.dashboard.presentation
...
import com.breezefieldsalesversacorp.*
import com.breezefieldsalesversacorp.R
import com.breezefieldsalesversacorp.app.*
import com.breezefieldsalesversacorp.app.NewFileUtils.browseDocuments
import com.breezefieldsalesversacorp.app.NewFileUtils.browsePDFDocuments
import com.breezefieldsalesversacorp.app.NewFileUtils.getExtension
import com.breezefieldsalesversacorp.app.domain.*
import com.breezefieldsalesversacorp.app.types.DashboardType
import com.breezefieldsalesversacorp.app.types.FragType
import com.breezefieldsalesversacorp.app.types.TopBarConfig
import com.breezefieldsalesversacorp.app.uiaction.DisplayAlert
import com.breezefieldsalesversacorp.app.utils.*
import com.breezefieldsalesversacorp.app.utils.AppUtils.Companion.isProfile
...
import com.breezefieldsalesversacorp.features.NewQuotation.*
import com.breezefieldsalesversacorp.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldsalesversacorp.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldsalesversacorp.features.SearchLocation.SearchLocationFragment
import com.breezefieldsalesversacorp.features.SearchLocation.locationInfoModel
import com.breezefieldsalesversacorp.features.TA.ViewAllTAListFragment
import com.breezefieldsalesversacorp.features.achievement.AchievementFragment
import com.breezefieldsalesversacorp.features.activities.presentation.*
import com.breezefieldsalesversacorp.features.addAttendence.*
import com.breezefieldsalesversacorp.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldsalesversacorp.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldsalesversacorp.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldsalesversacorp.features.addAttendence.model.GetReportToResponse
import com.breezefieldsalesversacorp.features.addAttendence.model.Leave_list_Response
import com.breezefieldsalesversacorp.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldsalesversacorp.features.addshop.presentation.AddShopFragment
import com.breezefieldsalesversacorp.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldsalesversacorp.features.addshop.presentation.ScanImageFragment
import com.breezefieldsalesversacorp.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldsalesversacorp.features.alarm.model.AlarmData
import com.breezefieldsalesversacorp.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldsalesversacorp.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldsalesversacorp.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldsalesversacorp.features.alarm.presetation.VisitReportFragment
import com.breezefieldsalesversacorp.features.attendance.AttendanceFragment
import com.breezefieldsalesversacorp.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldsalesversacorp.features.attendance.model.AttendanceRequest
import com.breezefieldsalesversacorp.features.attendance.model.AttendanceResponse
import com.breezefieldsalesversacorp.features.averageshop.presentation.AverageShopFragment
import com.breezefieldsalesversacorp.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldsalesversacorp.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldsalesversacorp.features.beatCustom.TeamBeatListFragment
import com.breezefieldsalesversacorp.features.billing.presentation.AddBillingFragment
import com.breezefieldsalesversacorp.features.billing.presentation.BillingDetailsFragment
import com.breezefieldsalesversacorp.features.billing.presentation.BillingListFragment
import com.breezefieldsalesversacorp.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldsalesversacorp.features.chat.model.ChatListDataModel
import com.breezefieldsalesversacorp.features.chat.model.ChatUserDataModel
import com.breezefieldsalesversacorp.features.chat.model.GroupUserDataModel
import com.breezefieldsalesversacorp.features.chat.presentation.*
import com.breezefieldsalesversacorp.features.chatbot.presentation.ChatBotFragment
import com.breezefieldsalesversacorp.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldsalesversacorp.features.chatbot.presentation.ReportsFragment
import com.breezefieldsalesversacorp.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldsalesversacorp.features.commondialog.presentation.CommonDialog
import com.breezefieldsalesversacorp.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldsalesversacorp.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldsalesversacorp.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldsalesversacorp.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldsalesversacorp.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldsalesversacorp.features.contacts.ActivityDtlsFrag
import com.breezefieldsalesversacorp.features.contacts.AddOpptFrag
import com.breezefieldsalesversacorp.features.contacts.ContactDtls
import com.breezefieldsalesversacorp.features.contacts.ContactGr
import com.breezefieldsalesversacorp.features.contacts.ContactsAddFrag
import com.breezefieldsalesversacorp.features.contacts.ContactsFrag
import com.breezefieldsalesversacorp.features.contacts.SchedulerAddFormFrag
import com.breezefieldsalesversacorp.features.contacts.SchedulerViewFrag
import com.breezefieldsalesversacorp.features.contacts.TemplateAddFrag
import com.breezefieldsalesversacorp.features.contacts.TemplateViewFrag
import com.breezefieldsalesversacorp.features.contacts.ViewCrmOpptFrag
import com.breezefieldsalesversacorp.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldsalesversacorp.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldsalesversacorp.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldsalesversacorp.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldsalesversacorp.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldsalesversacorp.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldsalesversacorp.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldsalesversacorp.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldsalesversacorp.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldsalesversacorp.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldsalesversacorp.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldsalesversacorp.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldsalesversacorp.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldsalesversacorp.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldsalesversacorp.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldsalesversacorp.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldsalesversacorp.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldsalesversacorp.features.document.presentation.DocumentListFragment
import com.breezefieldsalesversacorp.features.document.presentation.DocumentTypeListFragment
import com.breezefieldsalesversacorp.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldsalesversacorp.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldsalesversacorp.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldsalesversacorp.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldsalesversacorp.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldsalesversacorp.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldsalesversacorp.features.home.presentation.HomeFragment
import com.breezefieldsalesversacorp.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldsalesversacorp.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldsalesversacorp.features.know_your_state.KnowYourStateFragment
import com.breezefieldsalesversacorp.features.lead.LeadFrag
import com.breezefieldsalesversacorp.features.lead.ViewLeadFrag
import com.breezefieldsalesversacorp.features.leaderboard.LeaderBoardFrag
import com.breezefieldsalesversacorp.features.leaveapplynew.LeaveHome
import com.breezefieldsalesversacorp.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldsalesversacorp.features.localshops.LocalShopListFragment
import com.breezefieldsalesversacorp.features.localshops.LocalShopListMapFragment
import com.breezefieldsalesversacorp.features.localshops.NearByShopsMapFragment
import com.breezefieldsalesversacorp.features.location.*
import com.breezefieldsalesversacorp.features.location.api.LocationRepoProvider
import com.breezefieldsalesversacorp.features.location.model.*
import com.breezefieldsalesversacorp.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldsalesversacorp.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldsalesversacorp.features.login.ShopFeedbackEntity
import com.breezefieldsalesversacorp.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldsalesversacorp.features.login.presentation.LoginActivity
import com.breezefieldsalesversacorp.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldsalesversacorp.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldsalesversacorp.features.marketAssist.MarketAssistTabFrag
import com.breezefieldsalesversacorp.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldsalesversacorp.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldsalesversacorp.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldsalesversacorp.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldsalesversacorp.features.member.MapViewForTeamFrag
import com.breezefieldsalesversacorp.features.member.model.TeamLocDataModel
import com.breezefieldsalesversacorp.features.member.model.TeamShopListDataModel
import com.breezefieldsalesversacorp.features.member.presentation.*
import com.breezefieldsalesversacorp.features.menuBeat.MenuBeatFrag
import com.breezefieldsalesversacorp.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldsalesversacorp.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldsalesversacorp.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldsalesversacorp.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldsalesversacorp.features.myjobs.model.CustomerDataModel
import com.breezefieldsalesversacorp.features.myjobs.presentation.*
import com.breezefieldsalesversacorp.features.mylearning.MyLearningFragment
import com.breezefieldsalesversacorp.features.myorder.presentation.MyOrderListFragment
import com.breezefieldsalesversacorp.features.myprofile.presentation.MyProfileFragment
import com.breezefieldsalesversacorp.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldsalesversacorp.features.nearbyshops.model.ShopData
import com.breezefieldsalesversacorp.features.nearbyshops.model.ShopListResponse
import com.breezefieldsalesversacorp.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldsalesversacorp.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldsalesversacorp.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldsalesversacorp.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldsalesversacorp.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldsalesversacorp.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldsalesversacorp.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldsalesversacorp.features.newcollection.CollectionShopListFragment
import com.breezefieldsalesversacorp.features.newcollection.NewCollectionListFragment
import com.breezefieldsalesversacorp.features.newcollectionreport.*
import com.breezefieldsalesversacorp.features.notification.NotificationFragment
import com.breezefieldsalesversacorp.features.orderITC.CartListFrag
import com.breezefieldsalesversacorp.features.orderITC.OrderListFrag
import com.breezefieldsalesversacorp.features.orderITC.ProductListFrag
import com.breezefieldsalesversacorp.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldsalesversacorp.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldsalesversacorp.features.orderITC.ViewOrdDtls
import com.breezefieldsalesversacorp.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldsalesversacorp.features.orderList.NewOrderListFragment
import com.breezefieldsalesversacorp.features.orderList.OrderListFragment
import com.breezefieldsalesversacorp.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldsalesversacorp.features.orderhistory.ActivityMapFragment
import com.breezefieldsalesversacorp.features.orderhistory.OrderhistoryFragment
import com.breezefieldsalesversacorp.features.orderhistory.TimeLineFragment
import com.breezefieldsalesversacorp.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezefieldsalesversacorp.features.orderhistory.model.LocationData
import com.breezefieldsalesversacorp.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldsalesversacorp.features.performance.GpsStatusFragment
import com.breezefieldsalesversacorp.features.performance.PerformanceFragment
import com.breezefieldsalesversacorp.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldsalesversacorp.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldsalesversacorp.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldsalesversacorp.features.performanceAPP.PerformanceAppFragment
import com.breezefieldsalesversacorp.features.performanceAPP.allPerformanceFrag
import com.breezefieldsalesversacorp.features.permissionList.ViewPermissionFragment
import com.breezefieldsalesversacorp.features.photoReg.*
import com.breezefieldsalesversacorp.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldsalesversacorp.features.quotation.presentation.*
import com.breezefieldsalesversacorp.features.reimbursement.presentation.*
import com.breezefieldsalesversacorp.features.report.presentation.*
import com.breezefieldsalesversacorp.features.returnsOrder.*
import com.breezefieldsalesversacorp.features.settings.presentation.SettingsFragment
import com.breezefieldsalesversacorp.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldsalesversacorp.features.shopdetail.presentation.*
import com.breezefieldsalesversacorp.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesversacorp.features.stock.StockDetailsFragment
import com.breezefieldsalesversacorp.features.stock.StockListFragment
import com.breezefieldsalesversacorp.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsalesversacorp.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldsalesversacorp.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldsalesversacorp.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldsalesversacorp.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldsalesversacorp.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldsalesversacorp.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldsalesversacorp.features.survey.SurveyFrag
import com.breezefieldsalesversacorp.features.survey.SurveyViewDtlsFrag
import com.breezefieldsalesversacorp.features.survey.SurveyViewFrag
import com.breezefieldsalesversacorp.features.task.presentation.AddTaskFragment
import com.breezefieldsalesversacorp.features.task.presentation.CalenderTaskFragment
import com.breezefieldsalesversacorp.features.task.presentation.EditTaskFragment
import com.breezefieldsalesversacorp.features.task.presentation.TaskListFragment
import com.breezefieldsalesversacorp.features.taskManagement.TaskManagementFrag
import com.breezefieldsalesversacorp.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldsalesversacorp.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldsalesversacorp.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldsalesversacorp.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldsalesversacorp.features.viewAllOrder.CartFragment
import com.breezefieldsalesversacorp.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldsalesversacorp.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldsalesversacorp.features.viewAllOrder.ViewCartFragment
import com.breezefieldsalesversacorp.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldsalesversacorp.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldsalesversacorp.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldsalesversacorp.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldsalesversacorp.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldsalesversacorp.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldsalesversacorp.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldsalesversacorp.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldsalesversacorp.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldsalesversacorp.features.viewPPDDStock.ViewStockFragment
import com.breezefieldsalesversacorp.features.weather.presentation.WeatherFragment
import com.breezefieldsalesversacorp.mappackage.MapActivity
import com.breezefieldsalesversacorp.mappackage.MapActivityWithoutPath
import com.breezefieldsalesversacorp.mappackage.SendBrod
import com.breezefieldsalesversacorp.widgets.AppCustomEditText
import com.breezefieldsalesversacorp.widgets.AppCustomTextView
...
import com.breezefieldsalesversacorp.features.login.api.opportunity.OpportunityRepoProvider
import com.breezefieldsalesversacorp.features.mylearning.BookmarkFetchResponse
import com.breezefieldsalesversacorp.features.mylearning.BookmarkFrag
import com.breezefieldsalesversacorp.features.mylearning.BookmarkPlayFrag
import com.breezefieldsalesversacorp.features.mylearning.KnowledgeHubAllVideoList
import com.breezefieldsalesversacorp.features.mylearning.LeaderboardLmsFrag
import com.breezefieldsalesversacorp.features.mylearning.LmsQuestionAnswerSet
import com.breezefieldsalesversacorp.features.mylearning.MyLearningAllVideoList
import com.breezefieldsalesversacorp.features.mylearning.MyLearningTopicList
import com.breezefieldsalesversacorp.features.mylearning.MyLearningVideoPlay
import com.breezefieldsalesversacorp.features.mylearning.MyPerformanceFrag
import com.breezefieldsalesversacorp.features.mylearning.NotificationLMSFragment
import com.breezefieldsalesversacorp.features.mylearning.SearchLmsFrag
import com.breezefieldsalesversacorp.features.mylearning.SearchLmsKnowledgeFrag
import com.breezefieldsalesversacorp.features.mylearning.SearchLmsLearningFrag
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldsalesversacorplogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesversacorplogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezefieldsalesversacorp/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezefieldsalesversacorplogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezefieldsalesversacorplogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezefieldsalesversacorplogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
            ...
            BaseActivity.compositeDisposable.add(
                repository.getBookmarkedApiCall(Pref.user_id.toString())
                    ...
                    .subscribe({ result ->
                        ...
                        if (response.status == NetworkConstant.SUCCESS) {
                            Pref.CurrentBookmarkCount = response.bookmark_list.distinctBy { it.content_id.toString() }.size
                            tv_saved_count.visibility=View.VISIBLE
