package com.breezefieldsalesversacorp.features.reimbursement.presentation
...
import com.breezefieldsalesversacorp.app.utils.AppUtils.Companion.convertFromRightToReverseFormatWithTime
import com.breezefieldsalesversacorp.app.utils.AppUtils.Companion.getFormattedDateForApi
import com.breezefieldsalesversacorp.app.utils.AppUtils.Companion.hideSoftKeyboard
import com.breezefieldsalesversacorp.app.utils.CustomTextWatcher
import com.breezefieldsalesversacorp.app.utils.PermissionUtils
import com.breezefieldsalesversacorp.app.utils.ProcessImageUtils_v1
...
import com.breezefieldsalesversacorp.features.reimbursement.api.ReimbursementConfigRepoProvider
import com.breezefieldsalesversacorp.features.reimbursement.api.applyapi.ApplyReimbursementRepoProvider
import com.breezefieldsalesversacorp.features.reimbursement.api.configfetchapi.ReimbursementConfigFetchRepoProvider
import com.breezefieldsalesversacorp.features.reimbursement.api.reimbursement_list_api.ReimbursementListRepoProvider
import com.breezefieldsalesversacorp.features.reimbursement.api.reimbursementshopapi.ReimbursementShopRepoProvider
import com.breezefieldsalesversacorp.features.reimbursement.model.*
import com.breezefieldsalesversacorp.features.reimbursement.model.reimbursement_shop.ReimbursementShopDataModel
import com.breezefieldsalesversacorp.features.reimbursement.model.reimbursement_shop.ReimbursementShopResponseModel
import com.breezefieldsalesversacorp.features.reimbursement.model.reimbursementlist.ReimbursementListDataModel
import com.breezefieldsalesversacorp.features.reimbursement.model.reimbursementlist.ReimbursementListDetailsModel
import com.breezefieldsalesversacorp.features.reimbursement.model.reimbursementlist.ReimbursementListResponseModel
...
class ReimbursementFragment : BaseFragment(), DateAdapter.onPetSelectedListener, View.OnClickListener, TabLayout.OnTabSelectedListener, RadioGroup.OnCheckedChangeListener {
    ...
    private fun initView(view: View) {
        ...
        //attachbreezefieldsalesversacorpData()
...
//                            XLog.d("ReimbursementConfigApiResponse ERROR: " + error.localizedMessage)
    ...
    private fun attachbreezefieldsalesversacorpData() {
